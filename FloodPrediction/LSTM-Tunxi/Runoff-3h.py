...
reframed = series_to_supervised(values, 12, 4)
...
pyplot.plot(inv_yhat[:500],'r--',label='predictions_LSTM')
# pyplot.plot(inv_yhat2[:1000],'c-.',label='predictions_IndRNN')
# pyplot.plot(inv_yhat3[:1000],'k:',label='predictions_LSTM+Zoneout')
pyplot.plot(inv_yhat1[:500],'g--',label='predictions_TG-LSTM')
pyplot.legend()
pyplot.savefig('Tunxi 3D1224', dpi=300)
pyplot.show()